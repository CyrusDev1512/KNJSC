...
for(const width of [1440,390])for(const role of ['staff','leader','manager','admin']){
 ...
 await page.goto(base+'/bao-cao/tong-hop/?nguon=van_don_moi&tu=2020-01-01&den=2025-12-31');
 ...
 await page.goto(base+'/?delivery_nguon=van_don_moi&tu=2020-01-01&den=2025-12-31');
