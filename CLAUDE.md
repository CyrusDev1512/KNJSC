...
`tests/test_truy_vet.py` đối chiếu docs/04 với docstring bài kiểm; nó đang đỏ ba
bài có sẵn (AC-11.23 chưa có bài; AC-22.x, 24.x, 27.3 có bài mà chưa vào docs/04).
Thêm AC mới thì cập nhật bộ đếm ở docs/06 theo thông báo của bài đó.
