...
**Nhóm Nội bộ** (ADR-015) là năm app nhỏ cùng khuôn: `documents` (Tài liệu),
...
Bảng tin, Văn hoá, Tài nguyên là của toàn công ty theo quyết định (Q64, Q65)
...
ngoại lệ phạm vi có chủ ý** (`culture/services/leaderboard_service.py`, Q66):
