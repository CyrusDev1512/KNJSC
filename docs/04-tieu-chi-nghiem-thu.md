...
| AC-22.14 | **Ô danh tính liệt kê mỗi người một dòng** (chủ dự án 19.09.2026): ngày có nhiều người thì ô Nhân sự và Leader xuống dòng theo từng người (`<span class="report-name">` khối riêng), không nhét chung một chuỗi nối dấu phẩy để cột hẹp bẻ giữa mã; cách nhóm giữ nguyên mỗi ngày một dòng; Excel vẫn ghi chuỗi nối bằng dấu phẩy | ADR-035 · ADR-037 | Tự động |
