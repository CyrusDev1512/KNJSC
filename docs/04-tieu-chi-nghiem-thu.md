...
| AC-10.10 | `seed_perf.clear()` xoá dòng giả **theo lô** `XOA_MOI_LUOT`, mỗi lô một giao dịch có `lock_timeout`, và gọi `on_progress(đã xoá, tổng)`; chờ khoá quá hạn thì báo lỗi chứ không treo (TL-43) | NFR-2 | Tự động |
