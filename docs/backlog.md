...
> 100 nghìn khách / 100 người** (7K, ADR-016, K27) đang ở PR nháp: đã đo, đã sửa
> năm nút thắt, còn nợ chạy trên máy anh/chị. Nghiệm thu bấm tay theo `docs/07`
> vẫn chờ anh/chị. Mục D chỉ còn `AC-5.1`.
...
`scripts/kiem-tai-kn-crm.*` chạy lại được trên máy có Docker. 110 tiêu chí, 97
trên 98 tự động có bài kiểm.
