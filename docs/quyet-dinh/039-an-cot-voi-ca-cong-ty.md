...
**Hệ quả đã biết.** Lúc chốt mục này, bộ lọc trỏ tới cột ẩn bị bỏ lặng lẽ (ghi là TL-53);
**đã xử lý cùng ngày** ở mục bổ sung "lọc theo cột ẩn vẫn chạy, kèm lời nhắc" ngay dưới —
lọc vẫn chạy và có chip/dòng nhắc (AC-39.8). Bài migration là AC-39.9.
