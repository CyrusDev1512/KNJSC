# ADR-017 — Năm tính năng nội bộ (Bảng tin, Tài liệu, Công việc, Văn hoá, Tài nguyên) là năm app riêng trong KN ERP, làm bản MVP trước
...
| Liên quan | ADR-004 · ADR-012 · FR-9 → FR-13 · AC-12 → AC-16 · backlog Q68 → Q77, K30, K31, N11, N12, S16 → S21 |
...
| Tỉ giá lấy từ dịch vụ ngoài | Đúng theo ngày | Thêm phụ thuộc mạng và thư viện; MVP chỉ cần con số cố định (S21) |
...
5. **Văn hoá:** ghi nhận đi **từ trên xuống** (Q75, rà soát 07.09.2026 — thay
   ...
   nộp, để sao không lệch — S19 nếu cần); mỗi ghi nhận sinh một dòng sao. Bảng xếp hạng doanh số đọc `orders.Order` toàn công ty — **ngoại lệ
   ...
   người bán đều tranh hạng, kể cả quản lý (Q76); bằng tổng và bằng số đơn thì
   đồng hạng kiểu thi đấu 1, 1, 3 và cùng nhận sao (Q77); người bán đã khoá
   không chiếm hạng; nhật ký thưởng ghi tỉ giá đã dùng.
6. **Tài nguyên là danh mục dùng chung:** mọi người đã đăng nhập xem toàn bộ,
   Manager trở lên thêm mục và thêm, sửa, gỡ; không sổ bàn giao (S16).
...
|---|---|---|
| Năm màn hình nội bộ chạy thật trên cùng phân quyền, cùng nhật ký, cùng dữ liệu mẫu | Thêm năm app, năm migration, một nhóm thanh bên | Tệp tài liệu ngoài sao lưu (K30); tỉ giá tạm (N11); giá trị văn hoá mẫu (N12) |
...
kanban, hay tỉ giá theo ngày thì mở các S16 → S21 thành quyết định mới.
