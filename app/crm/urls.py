...
urlpatterns = [
    # Trang chủ KN CRM: tổng quan có sidebar (ADR-014); tên `bang_tinh` giữ
    ...
    # Chọn bảng để nhập tệp (Leader trở lên) hay cấp quyền (Manager) — ADR-014
