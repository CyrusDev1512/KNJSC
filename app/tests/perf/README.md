...
Máy chủ phải chạy **gunicorn** (như Dockerfile: 3 tiến trình × 4 luồng gthread),
không đo trên `runserver`. Kịch bản không bấm giao diện: mỗi người ảo là một tab lưới gọi
