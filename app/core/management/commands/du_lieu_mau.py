...
#: nộp báo cáo (ADR-041) có gì mà chọn và cột Team của báo cáo Marketing không còn "Chưa có team".
        ...
        for ten_dn, ho_ten, cap_bac, ma_bp, ten_team, doi_mk in TAI_KHOAN:
            ...
            if co_san is not None:
                ...
                if ho_so is not None:
                    ...
                    # Tài khoản mẫu có từ trước khi team MKT 1 ra đời (ADR-041): gán team nếu còn trống
    ...
    def _bao_cao_marketing(self, bo_phan, nguoi):
        ...
        for ten, ma, kieu, nhan in COT_BC_MKT:
            ...
            form_service.add_field(
                ...
                # Bốn trường số bắt buộc (ADR-041) cùng Ngày và danh tính
