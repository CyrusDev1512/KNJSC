...
#: Trường bắt buộc trên biểu mẫu báo cáo Sale/MKT (chủ dự án 24.09.2026, ADR-041): Số Mess, CPQC,
...
#: Cột nhập cố ý KHÔNG đưa lên biểu mẫu MKT: Doanh thu nhập tay cũ (ADR-038) và Hóa đơn (ADR-041 —
...
def configure_forms(table, skip=()):
    ...
    biểu mẫu (Doanh thu nhập tay cũ — ADR-038, Hóa đơn — ADR-041), gỡ luôn trường đã có.
