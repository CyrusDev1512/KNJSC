"""ADR-041 — Form Nộp báo cáo ngày: dropdown Team, bốn trường bắt buộc, bỏ Hóa đơn, bố cục ngang."""
import re
...
def test_chon_team_tren_form_nhap(client, bang_mkt, mkt_source, departments, teams, nguoi_dung, make_user):
    """AC-41.1 — Form nộp báo cáo có dropdown các team đang hoạt động của bộ phận sở hữu biểu mẫu (không lẫn
...
def test_bon_truong_bat_buoc(client, bang_mkt, mkt_source, nguoi_dung):
    """AC-41.2 — Sau `configure_erp_reports`, form MKT bắt buộc Số Mess, CPQC, Số đơn, Doanh số (cùng Ngày,
...
def test_hoa_don_khong_con_tren_form_nhap(client, bang_mkt, nguoi_dung):
    """AC-41.3 — Form MKT đang có trường Hóa đơn thì `configure_erp_reports` gỡ nó và không tạo lại khi chạy
...
def test_bo_cuc_ngang_form_nhap(client, bang_mkt, mkt_source, nguoi_dung):
    """AC-41.4 — Form nộp báo cáo là một thẻ trải hết chiều rộng: hàng điều khiển Biểu mẫu · Team · Ngày, lưới
