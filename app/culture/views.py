"""Màn hình Văn hoá — FR-12.1 tới FR-12.5, ADR-017.
...
xuống (Q75) nên form chỉ hiện với Leader trở lên.
"""
...
def van_hoa_ghi_nhan(request):
    """Gửi một ghi nhận — FR-12.1. Nhân viên gọi thẳng đường này bị từ chối (Q75)."""
