"""Hằng của module Văn hoá — khai một chỗ (quy tắc 7), ADR-015."""
...
#: Mỗi ghi nhận cho người nhận bấy nhiêu sao — Q67
STARS_PER_RECOGNITION = 1
#: Ba người đứng đầu doanh số tháng trước nhận lần lượt — Q67
