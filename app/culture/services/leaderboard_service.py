...
def sales_leaderboard(period=None, *, limit=LEADERBOARD_ROWS, users=None):
    ...
    số đơn thì đồng hạng, người kế tiếp nhảy hạng — 1, 1, 3 (Q72). Mọi người
    bán đều tranh hạng, kể cả Manager và Admin lên đơn hộ (Q71). `limit=None`
...
def award_monthly_stars(period, *, actor=None, request=None):
    """Thưởng 5/3/1 sao cho ba hạng đầu của `period`; đồng hạng cùng nhận (Q72);
