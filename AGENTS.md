...
- **VPS đã chạy `main`**: phát hành ngày 25.09.2026 tại `85227ee`, image
  `knjsc-app:85227ee-main` trên năm dịch vụ. Phát hành sau lấy SHA đã kiểm chứng
  trên `main`; merge GitHub không tự cập nhật VPS. VPS vẫn là môi trường thử
  nghiệm, chưa có khách. Xem [biên bản](docs/phat-hanh-team-quyen-20260925.md)
