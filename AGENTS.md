...
- **VPS đã chạy `main`** từ 24.09.2026, bản phát hành `9c4d285`, image
  `knjsc-app:9c4d285-main` trên cả năm dịch vụ. Các lần phát hành sau lấy một SHA
  đã kiểm chứng trên `main`; merge GitHub không tự cập nhật VPS. VPS vẫn là môi
  trường thử nghiệm, chưa có khách. Xem [biên bản phát hành](docs/kiem-chung-phat-hanh-vps-main-20260924.md)
